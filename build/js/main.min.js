...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../local_modules/jquery/dist/jquery.min */ \"./src/local_modules/jquery/dist/jquery.min.js\");\n/* harmony import */ var _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _class_Slider_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./class/Slider.js */ \"./src/js/class/Slider.js\");\n/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! gsap */ \"./node_modules/gsap/index.js\");\n\n\n\n\n_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default.a.fn.exists = function () {\n  return _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(this).length;\n};\n\nvar projectFunc = {\n  createSlider: function createSlider() {\n    if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-slider-partners').exists()) {\n      var partnerSlider = new _class_Slider_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('.js-slider-partners', 3, 0);\n      partnerSlider.createSlider();\n      partnerSlider.updateSlider('arrow');\n      partnerSlider.updateSlider('pagination');\n    }\n\n    if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.product-related__items').exists()) {\n      var relatedSlider = new _class_Slider_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('.product-related__items', 4, 36);\n      relatedSlider.createSlider();\n      relatedSlider.updateSlider('arrow');\n      relatedSlider.updateSlider('pagination', 'custom');\n    }\n  },\n  hiddenTabs: function hiddenTabs(index) {\n    if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.auth-popup').exists()) {\n      try {\n        var includeBloc = document.querySelector('.auth-popup');\n        var tabsEl = includeBloc.querySelectorAll('.auth-popup__form');\n        var btnTab = includeBloc.querySelectorAll('.auth-popup__link');\n        tabsEl = Array.prototype.slice.call(tabsEl);\n        tabsEl = tabsEl.reverse();\n        btnTab = Array.prototype.slice.call(btnTab); // btnTab = btnTab.reverse();\n\n        var hideForm = new gsap__WEBPACK_IMPORTED_MODULE_2__[\"TimelineMax\"]({\n          reversed: true,\n          paused: true,\n          defaults: {\n            duration: 0.5\n          }\n        });\n        tabsEl.forEach(function (element, i) {\n          if (i !== index) {\n            hideForm.to(btnTab[i], 0.3, {\n              fontSize: '35px',\n              color: '#AAAAAA',\n              ease: gsap__WEBPACK_IMPORTED_MODULE_2__[\"Power1\"].inOut\n            }).to(element, 0.3, {\n              autoAlpha: 0,\n              display: 'none',\n              ease: gsap__WEBPACK_IMPORTED_MODULE_2__[\"Power1\"].inOut\n            }, '-=0.3');\n            hideForm.play();\n          }\n        });\n      } catch (err) {\n        console.log(err);\n      }\n    }\n  },\n  showTabs: function showTabs(index) {\n    if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.auth-popup').exists()) {\n      try {\n        var includeBloc = document.querySelector('.auth-popup');\n        var tabsEl = includeBloc.querySelectorAll('.auth-popup__form');\n        var btnTab = includeBloc.querySelectorAll('.auth-popup__link');\n        btnTab = Array.prototype.slice.call(btnTab);\n        tabsEl = Array.prototype.slice.call(tabsEl);\n        tabsEl = tabsEl.reverse();\n        var mainBloc = document.querySelector('.auth__box');\n        var showForm = new gsap__WEBPACK_IMPORTED_MODULE_2__[\"TimelineMax\"]({\n          reversed: true,\n          paused: true,\n          defaults: {\n            duration: 0.5\n          },\n          onStart: function onStart() {\n            setTimeout(function () {\n              console.log('end');\n              tabsEl[index].style.display = 'block';\n              mainBloc.style.maxHeight = 191 + tabsEl[index].scrollHeight + \"px\";\n              tabsEl[index].style.display = 'none';\n              console.log(mainBloc.style.maxHeight);\n            }, 100);\n          }\n        });\n        showForm.to(btnTab[index], 0.3, {\n          fontSize: '45px',\n          color: '#38393F',\n          ease: gsap__WEBPACK_IMPORTED_MODULE_2__[\"Power1\"].inOut\n        }).to(tabsEl[index], 0.3, {\n          autoAlpha: 1,\n          display: 'block',\n          ease: gsap__WEBPACK_IMPORTED_MODULE_2__[\"Power1\"].inOut\n        }, '+=0.1');\n        showForm.play();\n        console.log(index);\n      } catch (err) {\n        console.log(err);\n      }\n    }\n  },\n  hoverTab: function hoverTab(element, state) {\n    var hoverTab = new gsap__WEBPACK_IMPORTED_MODULE_2__[\"TimelineMax\"]({\n      reversed: true,\n      paused: true,\n      defaults: {\n        duration: 0.5\n      }\n    });\n    var hoverTabLeave = new gsap__WEBPACK_IMPORTED_MODULE_2__[\"TimelineMax\"]({\n      reversed: true,\n      paused: true,\n      defaults: {\n        duration: 0.5\n      }\n    });\n    hoverTab.to(element, {\n      color: '#38393F'\n    });\n    hoverTabLeave.to(element, {\n      color: '#AAAAAA'\n    });\n\n    if (state) {\n      hoverTab.play();\n      hoverTabLeave.reverse();\n    } else {\n      hoverTabLeave.play();\n      hoverTab.reverse();\n    }\n  },\n  setTabs: function setTabs() {\n    if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.auth-popup__link').exists()) {\n      try {\n        var includeBloc = document.querySelector('.auth-popup');\n        var btnTab = includeBloc.querySelectorAll('.auth-popup__link');\n        btnTab = Array.prototype.slice.call(btnTab);\n        projectFunc.hiddenTabs(1);\n        btnTab.forEach(function (element, i) {\n          element.addEventListener('click', function () {\n            projectFunc.showTabs(i);\n            projectFunc.hiddenTabs(i);\n            _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(element).addClass('active').siblings().removeClass('active');\n          });\n          element.addEventListener('mouseenter', function () {\n            projectFunc.hoverTab(element, true);\n          });\n          element.addEventListener('mouseleave', function () {\n            projectFunc.hoverTab(element, false);\n          });\n        });\n      } catch (err) {\n        console.log(err);\n      }\n    }\n  },\n  serviceHover: function serviceHover(element, state) {\n    var article = _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(element).find('.service__article');\n    var link = _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(element).find('.link');\n    var ic = _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(element).find('.link__ic');\n    var serviceBg = new gsap__WEBPACK_IMPORTED_MODULE_2__[\"TimelineMax\"]({\n      reversed: true,\n      paused: true,\n      defaults: {\n        duration: 0.5\n      }\n    });\n    var serviceBgLeave = new gsap__WEBPACK_IMPORTED_MODULE_2__[\"TimelineMax\"]({\n      reversed: true,\n      paused: true,\n      defaults: {\n        duration: 0.5\n      }\n    });\n    serviceBg.to(element, {\n      backgroundColor: '#2C43A1',\n      color: 'white',\n      ease: gsap__WEBPACK_IMPORTED_MODULE_2__[\"Back\"].easeOut.config(1.7)\n    }).to([link, article], {\n      color: 'white'\n    }, '-=0.5').set(ic, {\n      className: '+=link__ic color'\n    }, '-=0.5');\n    serviceBgLeave.to(element, {\n      backgroundColor: 'white',\n      color: '#38393f',\n      ease: gsap__WEBPACK_IMPORTED_MODULE_2__[\"Back\"].easeOut.config(1.7)\n    }).to([link, article], {\n      color: '#2c43a1'\n    }, '-=0.5').set(ic, {\n      className: '+=link__ic'\n    }, '-=0.5');\n\n    if (state) {\n      serviceBg.play();\n      serviceBgLeave.reverse();\n    } else {\n      serviceBgLeave.play();\n      serviceBg.reverse();\n    }\n  },\n  showOverlay: function showOverlay(status, popup) {\n    if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-overlay').exists()) {\n      var overlayEl = _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(popup).parent('.js-overlay');\n      var showOvTl = new gsap__WEBPACK_IMPORTED_MODULE_2__[\"TimelineMax\"]({\n        reversed: true,\n        paused: true,\n        defaults: {\n          duration: 0.6\n        },\n        onStart: projectFunc.lockedDOM,\n        onStartParams: [status, false],\n        onComplete: projectFunc.stateObject,\n        onCompleteParams: ['start', popup]\n      });\n      var hideOvTl = new gsap__WEBPACK_IMPORTED_MODULE_2__[\"TimelineMax\"]({\n        reversed: true,\n        paused: true,\n        defaults: {\n          duration: 0.3\n        },\n        onStart: projectFunc.stateObject,\n        onStartParams: ['end', popup],\n        onComplete: projectFunc.lockedDOM,\n        onCompleteParams: [status, true]\n      });\n      showOvTl.to(overlayEl, {\n        autoAlpha: 1,\n        ease: 'power2.out'\n      });\n      hideOvTl.to(overlayEl, {\n        autoAlpha: 0,\n        ease: 'power2.out'\n      }, '+=0.6');\n\n      if (status) {\n        showOvTl.reverse();\n        showOvTl.play();\n      } else {\n        hideOvTl.reverse();\n        hideOvTl.play();\n      }\n    }\n  },\n  formShow: function formShow(element, status) {\n    if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(element).exists()) {\n      var showMainMenu = new gsap__WEBPACK_IMPORTED_MODULE_2__[\"TimelineMax\"]({\n        reversed: true,\n        paused: true,\n        defaults: {\n          duration: 10\n        }\n      });\n      var hideMainMenu = new gsap__WEBPACK_IMPORTED_MODULE_2__[\"TimelineMax\"]({\n        paused: true\n      });\n      var formShowTl = new gsap__WEBPACK_IMPORTED_MODULE_2__[\"TimelineMax\"]({\n        reversed: true,\n        paused: true,\n        defaults: {\n          duration: 1.4\n        }\n      });\n      var formHideTl = new gsap__WEBPACK_IMPORTED_MODULE_2__[\"TimelineMax\"]({\n        reversed: true,\n        paused: true,\n        defaults: {\n          duration: 1.1\n        },\n        onComplete: function onComplete() {\n          hideMainMenu.play();\n        }\n      });\n      formHideTl.to(element, {\n        yPercent: -100,\n        ease: 'power4.inOut'\n      });\n      formShowTl.set(element, {\n        autoAlpha: 1\n      }).to(element, {\n        yPercent: 0,\n        ease: 'power4.inOut'\n      }).add(showMainMenu.play(), '-=1.3');\n      showMainMenu.set(['.menu-popup__title', '.search-input'], {\n        autoAlpha: 0,\n        yPercent: -35\n      }).set('.catalog-list__bloc', {\n        autoAlpha: 0,\n        xPercent: -35\n      }).to('.menu-popup__title', 1, {\n        autoAlpha: 1,\n        yPercent: 0,\n        ease: 'power4.inOut'\n      }).to('.search-input', 1, {\n        autoAlpha: 1,\n        yPercent: 0,\n        ease: 'power4.inOut'\n      }, '-=0.7').to('.catalog-list__bloc', {\n        autoAlpha: 1,\n        xPercent: 0,\n        duration: 1,\n        stagger: 0.25,\n        ease: 'power4.inOut'\n      }, '-=1.9');\n      hideMainMenu.set(['.menu-popup__title', '.search-input'], {\n        autoAlpha: 0,\n        yPercent: -35\n      }).set('.catalog-list--search .catalog-list__bloc', {\n        autoAlpha: 0,\n        xPercent: -35\n      });\n\n      if (status) {\n        formHideTl.reverse();\n        formShowTl.play();\n      } else {\n        formShowTl.reverse();\n        formHideTl.play();\n      }\n    }\n  },\n  lockedDOM: function lockedDOM(status) {\n    if (status) {\n      _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('html').css('overflow', 'hidden');\n    } else {\n      _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('html').css('overflow', 'auto');\n    }\n  },\n  stateObject: function stateObject(status, popup) {\n    if (status === 'start') {\n      projectFunc.formShow(popup, true);\n    } else {\n      projectFunc.formShow(popup, false);\n    }\n  }\n};\n\nfunction init() {\n  projectFunc.setTabs();\n  projectFunc.createSlider();\n}\n\nwindow.addEventListener('load', function () {\n  init();\n\n  if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-btn-menu').exists()) {\n    var popup = document.querySelector('.js-menu-popup');\n    gsap__WEBPACK_IMPORTED_MODULE_2__[\"gsap\"].set(popup, {\n      yPercent: -100\n    });\n    _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-btn-menu').on('click', function () {\n      if (popup) {\n        _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.menu-btn').addClass('open');\n        projectFunc.formShow(popup, true);\n      }\n    });\n  }\n\n  if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-menu-close').exists()) {\n    var _popup = document.querySelector('.js-menu-popup');\n\n    _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-menu-close').on('click', function () {\n      if (_popup) {\n        _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.menu-btn').removeClass('open');\n        projectFunc.formShow(_popup, false);\n      }\n    });\n  }\n\n  _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.menu-btn').click(function () {\n    _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.menu-btn').toggleClass('open');\n  });\n\n  if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-input').exists()) {\n    try {\n      _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-input').each(function (_, element) {\n        _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(element).focus(function () {\n          _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(element).parent().addClass('on-focus');\n        }).blur(function () {\n          if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(element).val() === '') {\n            _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(element).parent().removeClass('on-focus');\n          }\n        });\n\n        if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(element).prop('disabled') === true) {\n          _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(element).parent().addClass('disabled');\n        }\n      });\n    } catch (err) {\n      console.log(err);\n    }\n  }\n\n  if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.service__bloc').exists()) {\n    gsap__WEBPACK_IMPORTED_MODULE_2__[\"gsap\"].utils.toArray('.service__bloc').forEach(function (item) {\n      item.addEventListener('mouseenter', function () {\n        projectFunc.serviceHover(item, true);\n      });\n      item.addEventListener('mouseleave', function () {\n        projectFunc.serviceHover(item, false);\n      });\n    });\n  }\n\n  if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.header__inner').exists) {\n    try {\n      var $window = _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(window);\n      var $target = _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.header__inner');\n      var $h = $target.offset().top;\n      $window.on('scroll', function () {\n        var scrollTop = window.pageYOffset || document.documentElement.scrollTop;\n\n        if (scrollTop > $h) {\n          $target.addClass('mf-scroll'); // return;\n        } else {\n          $target.removeClass('mf-scroll');\n        } // return;\n\n      });\n    } catch (err) {\n      console.log(err);\n    }\n  }\n\n  _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('input[type=file]').change(function () {\n    var label = _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.file .file__label');\n\n    if (typeof _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('input[type=file]').files !== 'undefined') {\n      if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('input[type=file]').files.length === 0) {\n        label.text(label.data('default'));\n      } else {\n        var file = _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('input[type=file]').files[0];\n        var name = file.name;\n        label.text(name);\n      }\n    } else {\n      var _name = _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('input[type=file]').value.split('\\\\');\n\n      label.text(_name[_name.length - 1]);\n    }\n\n    return false;\n  });\n\n  if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-open-modal').exists()) {\n    _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-open-modal').on('click', function (event) {\n      event.preventDefault();\n      _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-modal').addClass('open');\n    });\n  }\n\n  if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-close-modal').exists()) {\n    _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-close-modal').on('click', function () {\n      _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.js-modal').removeClass('open');\n    });\n  }\n});\n\n//# sourceURL=webpack:///./src/js/main.js?");
...
/***/ "./src/local_modules/swiper/swiper-bundle.min.js":
/*!*******************************************************!*\
  !*** ./src/local_modules/swiper/swiper-bundle.min.js ***!
  \*******************************************************/
/*! no static exports found */
